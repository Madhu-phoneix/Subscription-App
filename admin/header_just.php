...
// if($mainobj->new_install == '0'){
    ...
    if($total_subscription_order_sale > $amount_exceed && $logged_in_customer_id == ''){
      ...
      $redirectPage = 'https://admin.shopify.com/store/'.$store_name.'/apps/'.$mainobj->SHOPIFY_APIKEY.'/embed_subscription/admin/app_plans.php?shop='.$store;
...
<?php if($logged_in_customer_id == ''){?>
  ...
  <ui-nav-menu>
    ...
    <a href="/subscription/admin/plans/subscription_group.php">My Plans</a>
    <a href="/subscription/admin/subscription/subscriptions.php">Subscriptions</a>
    <a href="/subscription/admin/subscriptionOrders.php">Subscription orders</a>
    <a href="/subscription/admin/settings/setting.php">Settings</a>
    <a href="/subscription/admin/analytics.php">Analytics</a>
    <a href="/subscription/admin/documentation.php">Documentation</a>
    <a href="/subscription/admin/video_tutorials.php">Video Tutorials</a>
    <a href="/subscription/admin/contactUs.php">Contact Us</a>
    <a href="/subscription/admin/app_plans.php">App Plans</a>
  </ui-nav-menu>
<?php } ?>
...
<?php if($mainobj->store != 'predictive-search.myshopify.com'){ ?>
<div class="sd-overlay-loader"></div>
