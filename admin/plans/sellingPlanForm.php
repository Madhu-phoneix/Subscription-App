                           ...
                           <div class="Polaris-Connected">
                              <div class="Polaris-Connected__Item Polaris-Connected__Item--primary">
                                 <div class="Polaris-TextField">
                                    ...
                                    <input placeholder = "eg. delivery every day/week/month/year" id="frequency_plan_name" type="text" value="" class="Polaris-TextField__Input restrict_input_single_quote" maxlength="50" name="frequency_plan_name" aria-labelledby="TextField6Label" aria-invalid="false" autocomplete="off">
