...
if ($logged_in_customer_id == '') {
   ...
   $empty_contract_redirect_page = $mainobj->SHOPIFY_DOMAIN_URL . '/admin/subscription/boneSubscriptions.php?shop=' . $mainobj->store;
   ...
   $empty_contract_redirect_page = 'https://' . $mainobj->store . '/apps/your-subscriptions';
...
if(isset($_GET['contract_id']) && ($_GET['contract_id'] != '')){
   ...
   // if($mainobj->store == 'ritika-subscription.myshopify.com'){
   //   echo $getContractData_qry;
   //   die;
   // }
   ...
   $order_currency = $mainobj->getCurrencySymbol($getContractData[0]['order_currency']);
   ...
   $SHOPIFY_APIKEY = $mainobj->SHOPIFY_APIKEY;
   ?>
   <div class="Polaris-Layout__Section sd-dashboard-page <?php echo  $parent_class; ?>" <?php echo $pageCSS; ?>>
      ...
      <div>
         <div class="Polaris-Page-Header Polaris-Page-Header--isSingleRow Polaris-Page-Header--mobileView Polaris-Page-Header--noBreadcrumbs Polaris-Page-Header--mediumTitle">
            <div class="Polaris-Page-Header__Row sd_contractNavigation">
               ...
               <?php if($logged_in_customer_id == ''){ ?>
                  <nav role="navigation">
                     <a class="Polaris-Breadcrumbs__Breadcrumb  navigate_element" data-usecase="subscription_form_leave" data-heading="Unsaved changes" data-query-string="" data-message="If you leave this page, any unsaved changes will be lost." data-acceptbuttontext="" data-rejectbuttontext="" data-confirmbox="" data-redirect-link="/subscription/admin/subscription/boneSubscriptions.php?shop=<?php echo $mainobj->store; ?>" data-polaris-unstyled="true" href="javascript:void(0)">
               ...
               <?php }else{ ?>
                  <nav role="navigation">
                     <a class="Polaris-Breadcrumbs__Breadcrumb" href="<?php echo 'https://'.$mainobj->store.'/apps/your-subscriptions'; ?>" data-polaris-unstyled="true">
                        <span class="Polaris-Breadcrumbs__ContentWrapper">
                           <span class="Polaris-Breadcrumbs__Icon">
                              <span class="Polaris-Icon">
                                 <svg viewBox="0 0 20 20" class="Polaris-Icon__Svg" focusable="false" aria-hidden="true">
                        ...
                        <div class="Polaris-Banner__ContentWrapper">
                           <div class="Polaris-Banner__Heading" id="PolarisBanner18Heading">
                              ...
                              <?php if($disable_customer_delete_contract == 'disabled'){ ?>
                                 ...
                                 <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true" class="as-h-4 as-w-4 as-text-white as-mr-2" style="margin-right: 5px;"><path stroke-linecap="round" stroke-linejoin="round" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"></path></svg>
         ...
         <div id="polaris-example" class="PolarisExampleWrapper_Example__NK9R0"><div class="Polaris-Banner Polaris-Banner--statusCritical Polaris-Banner--hasDismiss Polaris-Banner--withinPage" tabindex="0" role="alert" aria-live="polite" aria-labelledby="PolarisBanner1Heading" aria-describedby="PolarisBanner1Content"><div class="Polaris-Banner__Ribbon"><span class="Polaris-Icon Polaris-Icon--colorCritical Polaris-Icon--applyColor"><span class="Polaris-Text--root Polaris-Text--bodySm Polaris-Text--regular Polaris-Text--visuallyHidden"></span><svg viewBox="0 0 20 20" class="Polaris-Icon__Svg" focusable="false" aria-hidden="true"><path d="M11.768.768a2.5 2.5 0 0 0-3.536 0l-7.464 7.464a2.5 2.5 0 0 0 0 3.536l7.464 7.464a2.5 2.5 0 0 0 3.536 0l7.464-7.464a2.5 2.5 0 0 0 0-3.536l-7.464-7.464zm-2.768 5.232a1 1 0 1 1 2 0v4a1 1 0 1 1-2 0v-4zm2 8a1 1 0 1 1-2 0 1 1 0 0 1 2 0z"></path></svg></span></div><div class="Polaris-Banner__ContentWrapper"><div class="Polaris-Banner__Heading" id="PolarisBanner1Heading"><p class="Polaris-Text--root Polaris-Text--headingMd Polaris-Text--semibold">If you edit the subscription product price then all the existing discount will be removed if applied.</p></div></div></div></div>
         <?php } ?>
         <?php if($logged_in_customer_id == '') { ?>
            <div id="polaris-example" class="PolarisExampleWrapper_Example__NK9R0 sd_funds_note"><div class="Polaris-Banner Polaris-Banner--statusInfo Polaris-Banner--hasDismiss Polaris-Banner--withinPage" tabindex="0" role="status" aria-live="polite" aria-labelledby="PolarisBanner1Heading" aria-describedby="PolarisBanner1Content"><div class="Polaris-Banner__Ribbon"><span class="Polaris-Icon Polaris-Icon--colorHighlight Polaris-Icon--applyColor"><span class="Polaris-Text--root Polaris-Text--bodySm Polaris-Text--regular Polaris-Text--visuallyHidden"></span><svg viewBox="0 0 20 20" class="Polaris-Icon__Svg" focusable="false" aria-hidden="true"><path fill-rule="evenodd" d="M10 20c5.514 0 10-4.486 10-10s-4.486-10-10-10-10 4.486-10 10 4.486 10 10 10zm1-6a1 1 0 1 1-2 0v-4a1 1 0 1 1 2 0v4zm-1-9a1 1 0 1 0 0 2 1 1 0 0 0 0-2z"></path></svg></span></div><div class="Polaris-Banner__ContentWrapper"><div class="Polaris-Banner__Heading" id="PolarisBanner1Heading"><p class="Polaris-Text--root Polaris-Text--headingMd Polaris-Text--semibold">As per the shopify policy, you can't receive funds if your payout is below $1, £1, or €1, depending on which currency you use in your store. The funds are added to your next payout that meets this requirement.</p></div></div></div></div>
         <?php } ?>
         <?php if (!empty($getContractData)) {
            if($logged_in_customer_id == ''){
               $customer_name = '<a href="https://'.$mainobj->store.'/admin/customers/'.$getContractData[0]['shopify_customer_id'].'" target="_blank">'.$getContractData[0]['name'].'</a>';
            }else{
                        ...
                        <div class="Polaris-Card">
                           ...
                           <div class="Polaris-Card__Section">
                              <div class="sd_orderDetail">
                                 <p><?php echo $tickMarkSvg; ?>Delivery Period </p><b><?php echo $getContractData[0]['delivery_policy_value'] . ' ' . $getContractData[0]['delivery_billing_type']; ?></b>
                              </div>
                              <div class="sd_orderDetail">
                                          ...
                                          <div class="Polaris-TextField sd-small-textfield">
                                             ...
                                             <div class="Polaris-Select sd-small-select">
                                                <select id="sd_pay_per_delivery_billing_type" name="sd_pay_per_delivery_billing_type" class="Polaris-Select__Input" aria-invalid="false">
                                                   <option value="DAY" <?php if(strtoupper($getContractData[0]['delivery_billing_type']) == 'DAY'){ echo 'selected'; } ?>>DAY</option>
                                                   <option value="WEEK" <?php if(strtoupper($getContractData[0]['delivery_billing_type']) == 'WEEK'){ echo 'selected'; } ?>>WEEK</option>
                                                   <option value="MONTH" <?php if(strtoupper($getContractData[0]['delivery_billing_type']) == 'MONTH'){ echo 'selected'; } ?>>MONTH</option>
                                                   <option value="YEAR" <?php if(strtoupper($getContractData[0]['delivery_billing_type']) == 'YEAR'){ echo 'selected'; } ?>>YEAR</option>
                                                </select>
                              ...
                              <?php if($logged_in_customer_id == '' && $currentStatus == 'Active'){ ?>
                                 <span class="update_next_billing_date"><b class="sd_next_billing_date">
                                    <?php if ($currentStatus == 'Active') {
                                       ...
                                       $shop_timezone_date = $mainobj->getShopTimezoneDateFormat(($next_bill_date . ' ' . $date_time_array[1]), $shop_timezone);
                                       ...
                                       if ($getContractData[0]['delivery_policy_value'] == $getContractData[0]['billing_policy_value']) {
                                          $shop_timezone_date = $mainobj->getShopTimezoneDateFormat(date('Y-m-d H:i:s'), $shop_timezone);
                                       }
                                    ?>
                                    </b>
                                   <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                       ...
                                       <div class="Polaris-Connected__Item Polaris-Connected__Item--primary">
                                          <div class="Polaris-TextField Polaris-TextField--hasValue">
                                             <div class="Polaris-TextField__Prefix" id="select_next_billing_date-Prefix">
                                                <svg viewBox="0 0 20 20" style="height: 18px;"><path fill-rule="evenodd" d="M17.5 2H15V1a1 1 0 10-2 0v1H6V1a1 1 0 00-2 0v1H2.5C1.7 2 1 2.7 1 3.5v15c0 .8.7 1.5 1.5 1.5h15c.8 0 1.5-.7 1.5-1.5v-15c0-.8-.7-1.5-1.5-1.5zM3 18h14V8H3v10z" fill="#5C5F62"></path></svg>
                                             </div>
                                             <input id="select_next_billing_date" autocomplete="off" class="Polaris-TextField__Input" next-billing-date = "<?php echo $mainobj->getShopTimezoneDateFormat(($next_bill_date . ' ' . $date_time_array[1]), $shop_timezone); ?>" type="text" value="<?php echo $shop_timezone_date; ?>" readonly>
                                             <div class="Polaris-TextField__Backdrop"></div>
                                          </div>
                                       </div>
                                    </div>
                              ...
                              <?php } ?>
                              <div class="sd_orderDetail">
                                 <p><?php echo $tickMarkSvg; ?>Initial Order No. </p><b>#<?php echo $getContractData[0]['order_no']; ?></b>
                              </div>
                           ...
                           <div>
                              ...
                              <div class="sd_contractTabs Polaris-Tabs__Panel" id="sd_contractProducts_content">
                                 ...
                                 <div class="Polaris-Card__Section sd_productListing">
                                    <?php if($logged_in_customer_id == ''){?>
                                    <button class="Polaris-Button Polaris-Button--primary add_newProducts" data-out_of_stock ="<?php echo $getContractData[0]['add_out_of_stock_product']; ?>" type="button" product-display-style="prdouct-box" parent-id=''><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                                    ...
                                    <?php }else if($logged_in_customer_id != '' && $getContractData[0]['add_subscription_product'] == '1'){ ?>
                                       <button class="Polaris-Button Polaris-Button--primary add_newProducts_customer" data-out_of_stock ="<?php echo $getContractData[0]['add_out_of_stock_product']; ?>" type="button" product-display-style="prdouct-box" parent-id=''><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                                          <path d="M15 10a1 1 0 01-1 1h-3v3a1 1 0 11-2 0v-3H6a1 1 0 110-2h3V6a1 1 0 012 0v3h3a1 1 0 011 1zm-5-8a8 8 0 100 16 8 8 0 000-16z" fill="#5C5F62"></path>
                                       </svg>Add Products</button>
                                    <?php } ?>
                                    <div>
                                          ...
                                          <div id="sd_slider_1" class="sd_main_Slider">
                                             <?php if (!empty($all_contract_products)) {
                                                ...
                                                foreach ($all_contract_products as $key => $prdValue) {
                                                   ...
                                                   $edit_product_quantity = '';$add_stock_link = '';$edit_product_price='';
                                                   ...
                                                   if(is_int($found_variant_key) && (strlen((string)$found_variant_key) > 0) && (!empty($variant_ids_array[$found_variant_key]))){
                                                         ...
                                                         if((($logged_in_customer_id != '') && ($getContractData[0]['edit_product_price'] == '1')) || ($logged_in_customer_id == '') ){
                                                         ...
                                                         if($logged_in_customer_id == '' && ($variant_ids_array[$found_variant_key]['inventoryQuantity'] <= 0)){
                                                            $add_stock_link = '<span class="sd_totalInventory sd_out_of_stock">Out Of Stock</span><span class="Polaris-TextStyle--variationStrong"><a href="https://'.$mainobj->store.'/admin/products/'.$prdValue['product_id'].'/variants/'.$prdValue['variant_id'].'" target="_blank"><span class="Polaris-Badge Polaris-Badge--statusAttention Polaris-Badge--progressComplete">Add Stock</span></a></span>';
                                                         }
                                                   }
                                                   ...
                                                   <div class="product_main_box_inner">
                                                      <div class="product_main_box">
                                                         <div class="product_main_outer">
                                                            ...
                                                            <div class="Polaris-Card__Section">
                                                               <div class="sd_product-content">
                                                                  ...
                                                                  <div class="sd_prdQuantity">Quantity : <span class="sd_oldQuantity_<?php echo $prdValue['variant_id'] ?>" data-oldQty="<?php echo $prdValue['quantity']; ?>"><?php echo $prdValue['quantity']; ?><?php echo $edit_product_quantity; ?> </span>
                                                            ...
                                                            <?php
                                                            if($getContractData[0][$get_dicount_type.'discount_value'] == 0 || $getContractData[0][$get_dicount_type.'discount_value'] == '' || $getContractData[0][$get_dicount_type.'discount_value'] == '0') { ?> <?php }else{?><div p-color-scheme="light"><span class="Polaris-Badge Polaris-Badge--statusInfo"><span class="Polaris-VisuallyHidden">Info </span>Saved <?php if($getContractData[0][$get_dicount_type.'discount_type'] == 'A'){ echo $order_currency; } echo $getContractData[0][$get_dicount_type.'discount_value'].' ';  if($getContractData[0][$get_dicount_type.'discount_type'] == 'P'){echo "%"; }?></span>
                                                            <div id="PolarisPortalsContainer"></div>
                                                            </div><?php }?>
                                                             <!-- show discount div ends here -->
                                                         </div>

                                                         <div class="sd_editProduct sd_updateProductButton_<?php echo $prdValue['variant_id'] ?> <?php if($edit_product_quantity == ''){ echo 'no_update_button';}?>">
                                                            <?php
                                                         ...
                                                         <?php if($prdValue['product_shopify_status'] == 'Deleted'){ ?>
                                                            <div class="sd_product_delete">  <p> Product has been removed !</p></div>
                                                         <?php } ?>
                                                      </div>
                                                   </div><!-- wrapper end -->
                                             <?php }
      ...
      <div class="Polaris-Layout__Section sd_contracts sd_contractDetails">
            <div>
               <div class="Polaris-Card">
                           ...
                           <div class="Polaris-ResourceList__ResourceListWrapper">
                              <ul class="Polaris-ResourceList" aria-live="polite">
                                                ...
                                                <div class="Polaris-ResourceItem__Container" id="145">
                                                   <div class="Polaris-ResourceItem__Content">
                                                      ...
                                                      foreach ($all_products_array as $key => $prdValue) {
                                                         ...
                                                         if($logged_in_customer_id == ''){
                                                           $order_number = '<a href="https://'. $mainobj->store.'/admin/orders/'.$itemValue['order_id'].'" target="_blank">#'.$itemValue['order_no'].'</a>';
                                                         }else{
                                                      ...
                                                      <div id="sd_display" style="display: flex;">
                                                         ...
                                                         <p><span>Order Date</span><?php echo   $mainobj->getShopTimezoneDate(($itemValue['updated_at']), $shop_timezone); ?></p>
                                                      </div>
                                                   </div>
                                                   <?php if($logged_in_customer_id == ''){?>
                                                   <div class="Polaris-Stack__Item">
                                                   <div class="Polaris-ButtonGroup">
                                                      ...
                                                      <a class="Polaris-Navigation__Item arrow-icon no-focus"  tabindex="0" data-polaris-unstyled="true" href="https://<?php echo $mainobj->store; ?>/admin/orders/<?php echo $itemValue['order_id']; ?>" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" width="15px" height="20px" padding="10px" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M19.928 9.629c-2.137-5.343-6.247-7.779-10.355-7.565-4.06.21-7.892 3.002-9.516 7.603l-.118.333.118.333c1.624 4.601 5.455 7.393 9.516 7.603 4.108.213 8.218-2.222 10.355-7.565l.149-.371-.149-.371zm-9.928 5.371a5 5 0 1 0 0-10 5 5 0 0 0 0 10z"></path><circle cx="10" cy="10" r="3"></circle></svg></a>
                                                      </div>
                                                   </div>
                                                </div>
                                                   <?php } ?>
                                 ...
                                 foreach ($orderContractProducts_array as $key => $itemValue) {
                                    ...
                                    if($logged_in_customer_id == ''){
                                      $order_number = '<a href="https://'.$mainobj->store.'/admin/orders/'.$getContractData[0]['order_id'].'" target="_blank">#'.$getContractData[0]['order_no'].'</a>';
                                    }else{
                                       ...
                                       <div class="Polaris-ResourceItem">
                                          ...
                                          <div class="Polaris-ResourceItem__Container" id="145">
                                             ...
                                             <div class="Polaris-Stack__Item">
                                                <div class="Polaris-ButtonGroup">
                                                   <div class="Polaris-ButtonGroup__Item Polaris-ButtonGroup__Item--plain">
                                                   <a class="Polaris-Navigation__Item arrow-icon no-focus" data-query-string="4222320878" tabindex="0" data-polaris-unstyled="true" href="https://<?php echo $mainobj->store; ?>/admin/orders/<?php echo $getContractData[0]['order_id']; ?>" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" width="20px" height="15px" padding="20px" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M19.928 9.629c-2.137-5.343-6.247-7.779-10.355-7.565-4.06.21-7.892 3.002-9.516 7.603l-.118.333.118.333c1.624 4.601 5.455 7.393 9.516 7.603 4.108.213 8.218-2.222 10.355-7.565l.149-.371-.149-.371zm-9.928 5.371a5 5 0 1 0 0-10 5 5 0 0 0 0 10z"></path><circle cx="10" cy="10" r="3"></circle></svg></a>
                                                   </div>
                                                </div>
                                             </div>
                                             <?php } ?>
                  ...
                  <div class="sd_subscription_tab sd_orderTabs-title sd_Tabs" group="sd_orderTabs" target-tab="sd_upcomingFulfillments_content"  role="tabpanel" tab-title="<?php if ($getContractData[0]['delivery_policy_value'] == $getContractData[0]['billing_policy_value']){echo "Upcoming Orders"; }else{echo "Upcoming Fulfillments";}?>">
                           ...
                           <ul class="Polaris-ResourceList" aria-live="polite">
                              ...
                              ?>
                                             ...
                                             <div class="Polaris-ResourceItem__Container" id="145">
                                                ...
                                                <div class="sd_billingAttempt">
                                                   <div class="sd_attemptBillingAndSkip">
                                                      ...
                                                      <?php } if($logged_in_customer_id == '' || ($logged_in_customer_id != '' && $getContractData[0]['skip_upcoming_order'] == '1')) {?>
                                 ...
                                 <?php
                                   ...
                                   $order_name = $get_upcoming_fulfillments_data['order_name'];
                                   $all_contract_line_items_array = $get_upcoming_fulfillments_data['all_contract_line_items'];
                                   $all_contract_line_items = ($all_contract_line_items_array[trim($contractId)]);
                                   foreach($get_upcoming_fulfillments_data['order_upcoming_fulfillments']['fulfillment_orders'] as $key => $value) {
                                    ...
                                    $fulfill_date = $mainobj->getShopTimezoneDate(($complete_fulfillment_date), $shop_timezone);
                                    // die;
                                    $actualFulfillmentDate = strtok($complete_fulfillment_date, 'T');
                                    // echo $actualFulfillmentDate;
                                 ?>
                                    <li class="Polaris-ResourceItem__ListItem">
                                       <div class="Polaris-ResourceItem__ItemWrapper">
                                          <div class="Polaris-ResourceItem">
                                                ...
                                                <div class="Polaris-ResourceItem__Content sd_fulfillments">
                                                   <p><span>Fulfill Date</span> <?php echo $mainobj->getShopTimezoneDate(($complete_fulfillment_date), $shop_timezone);  ?></p>
                                          ...
                                          <div class="Polaris-ResourceItem">
                                             ...
                                             <div class="Polaris-ResourceItem__Container" id="145">
                                                <div class="Polaris-ResourceItem__Content sd_pendingOrders">
                                                   ...
                                                   <p><span>Order Date</span><?php echo $mainobj->getShopTimezoneDate(($value['renewal_date'] . ' ' . $pending_date_time_array[1]), $shop_timezone); ?></p>
                                                   ...
                                                   <p><span>Order Attempt Date</span><?php echo $mainobj->getShopTimezoneDate(($value['billing_attempt_date'] . ' ' . $pending_date_time_array[1]), $shop_timezone); ?></p>
                                                </div>
                                             </div>
                                          </div>
                                       </div>
                                          ...
                                          <div class="Polaris-ResourceItem">
                                             ...
                                             <div class="Polaris-ResourceItem__Container" id="145">
                                                <div class="Polaris-ResourceItem__Content sd_failureOrders">
                                                   ...
                                                   <p><span>Order Date</span><?php echo $mainobj->getShopTimezoneDate(($value['renewal_date'] . ' ' . $failure_date_time_array[1]), $shop_timezone); ?></p>
                                                   <p><span>Status</span><span class="Polaris-Badge Polaris-Badge--statusAttention Polaris-Badge--progressPartiallyComplete"><span class="Polaris-VisuallyHidden">Info </span><?php echo $value['status']; ?></span></p>
                                                   <p><span>Order Attempt Date</span><?php echo $mainobj->getShopTimezoneDate(($value['billing_attempt_date'] . ' ' . $failure_created_time_array[1]), $shop_timezone); ?></p>
                                                   <p><span>Order Failure Date</span><?php echo $mainobj->getShopTimezoneDate(($value['billingAttemptResponseDate'] . ' ' . $failure_date_time_array[1]), $shop_timezone); ?>
                                                </div>
                                             </div>
                                          </div>
                                       </div>
                  ...
                  <div class="sd_subscription_tab sd_orderTabs-title sd_Tabs" group="sd_orderTabs" target-tab="sd_skipOrders_content"  role="tabpanel" tab-title="<?php if ($getContractData[0]['delivery_policy_value'] == $getContractData[0]['billing_policy_value']) { echo " Skip Orders"; } else { echo "Rescheduled Fulfillments of current cycle";
                              } ?>">
                                                ...
                                                <div class="Polaris-ResourceItem__Container" id="145">
                                                   <div class="Polaris-ResourceItem__Content">
                                                      <div class="Polaris-ResourceItem__Content sd_skipOrders">
                                                         ...
                                                         <p><span>Order Skipped Date</span><?php echo $mainobj->getShopTimezoneDate(($value['billing_attempt_date'] . ' ' . $skip_date_time_array[1]), $shop_timezone); ?></p>
                                                      </div>
                                                   </div>
                                                </div>
                                             </div>
                                                ...
                                                <div class="Polaris-ResourceItem__Container" id="145">
                                                   <div class="Polaris-ResourceItem__Content">
                                                      <div class="Polaris-ResourceItem__Content sd_rescheduleOrders">
                                                         ...
                                                         <p><span>Rescheduled Date</span><?php echo  $mainobj->getShopTimezoneDate(($value['new_fulfillment_date'] . ' ' . $schedule_date_time_array[1]), $shop_timezone);   ?></p>
                                                      </div>
                                                   </div>
                                                </div>
                                             </div>
...
// o.billing_policy_value,o.delivery_policy_value,o.sd_size,o.sd_gender,o.sd_product_type,
// o.delivery_billing_type,o.contract_status,
// o.order_token,o.order_no,o.created_at,o.updated_at,o.new_contract,
// o.next_billing_date,
// c.name,c.email,c.shopify_customer_id,d.shop_timezone FROM `subscriptionOrderContract` as o, `customers` as c, `store_details` as d  WHERE o.store_id = '$mainobj->store_id' and o.shopify_customer_id =c.shopify_customer_id and d.store_id = o.store_id $whereCustomerCondition ORDER BY o.id DESC");

$getContractData = $mainobj->customQuery("SELECT o.id,o.store_id,o.order_id,o.contract_id,
o.billing_policy_value,o.delivery_policy_value,o.sd_size,o.sd_gender,o.sd_product_type,
o.delivery_billing_type,o.contract_status,
o.order_token,o.order_no,o.created_at,o.updated_at,o.new_contract,
o.next_billing_date,i.variant_sku,
c.name,c.email,c.shopify_customer_id,d.shop_timezone FROM `subscriptionOrderContract` as o, `customers` as c, `subscritionOrderContractProductDetails` as i, `store_details` as d  WHERE o.store_id = '$mainobj->store_id' and o.shopify_customer_id =c.shopify_customer_id and o.contract_id = i.contract_id and i.product_contract_status = '1' and d.store_id = o.store_id $whereCustomerCondition ORDER BY o.id DESC");
...
?>
   ...
   <div class="loader sd_bone_loader" style="display:none"><div class="line-scale"><div></div><div></div><div></div><div></div><div></div></div></div>
      <div>
         <div class="Polaris-Card__Header sd_contractHeader">
            <div class="Polaris-Stack Polaris-Stack--alignmentBaseline">
               <div class="Polaris-Stack__Item Polaris-Stack__Item--fill">
                  <h2 class="Polaris-Heading">Subscriptions </h2>
               </div>
               <?php if ($logged_in_customer_id == '') { ?>
                  <div class="Polaris-Stack__Item">
                     <div class="Polaris-ButtonGroup">
                        <div class="Polaris-ButtonGroup__Item Polaris-ButtonGroup__Item--plain"><button class="Polaris-Button Polaris-Button--primary sd_import_contracts" type="button"><svg viewBox="0 0 20 20">
                                 <path d="M18.414 1.586a2 2 0 010 2.828l-3 3-1.115 1.115-2.828-2.828 1.232-1.233.015-.015 2.868-2.867a2 2 0 012.828 0zm-8.47 11.299l-2.788-2.787a4.67 4.67 0 01-5.919-5.901L3.76 6.719a1.5 1.5 0 002.121 0l.84-.84a1.5 1.5 0 000-2.12L4.197 1.236a4.67 4.67 0 015.9 5.919l2.787 2.787 5.506 5.506a2.08 2.08 0 01-2.942 2.942l-5.506-5.506zm-1.415 1.414l-3.287 3.287L1 19l1.414-4.243 3.287-3.286 2.828 2.828z" fill="#fff"></path>
                              </svg><span class="Polaris-Button__Content"><span class="Polaris-Button__Text">Import Contracts</span></span></button></div>
                        <div class="Polaris-ButtonGroup__Item Polaris-ButtonGroup__Item--plain"><button class="Polaris-Button Polaris-Button--primary sd_export_contracts" type="button"><svg viewBox="0 0 20 20">
                                 <path d="M18.414 1.586a2 2 0 010 2.828l-3 3-1.115 1.115-2.828-2.828 1.232-1.233.015-.015 2.868-2.867a2 2 0 012.828 0zm-8.47 11.299l-2.788-2.787a4.67 4.67 0 01-5.919-5.901L3.76 6.719a1.5 1.5 0 002.121 0l.84-.84a1.5 1.5 0 000-2.12L4.197 1.236a4.67 4.67 0 015.9 5.919l2.787 2.787 5.506 5.506a2.08 2.08 0 01-2.942 2.942l-5.506-5.506zm-1.415 1.414l-3.287 3.287L1 19l1.414-4.243 3.287-3.286 2.828 2.828z" fill="#fff"></path>
                              </svg><span class="Polaris-Button__Content"><span class="Polaris-Button__Text">Export Sample CSV</span></span></button></div>

                        <div class="Polaris-ButtonGroup__Item Polaris-ButtonGroup__Item--plain"><button class="Polaris-Button Polaris-Button--primary sd_selectSetting" data-popup="contract_setting" type="button"><svg viewBox="0 0 20 20">
                                 <path d="M18.414 1.586a2 2 0 010 2.828l-3 3-1.115 1.115-2.828-2.828 1.232-1.233.015-.015 2.868-2.867a2 2 0 012.828 0zm-8.47 11.299l-2.788-2.787a4.67 4.67 0 01-5.919-5.901L3.76 6.719a1.5 1.5 0 002.121 0l.84-.84a1.5 1.5 0 000-2.12L4.197 1.236a4.67 4.67 0 015.9 5.919l2.787 2.787 5.506 5.506a2.08 2.08 0 01-2.942 2.942l-5.506-5.506zm-1.415 1.414l-3.287 3.287L1 19l1.414-4.243 3.287-3.286 2.828 2.828z" fill="#fff"></path>
                              </svg><span class="Polaris-Button__Content"><span class="Polaris-Button__Text">Subscripiton Setting</span></span></button></div>

                        <div class="Polaris-ButtonGroup__Item Polaris-ButtonGroup__Item--plain sd-item-swipe-btn" style="display:none;"><button class="Polaris-Button  Polaris-Button--primary Polaris-Button--pressable Polaris-Button--variantSecondary Polaris-Button--sizeMedium Polaris-Button--textAlignCenter sd_custom-product-action" type="button">
                              <svg  xmlns="http://www.w3.org/2000/svg" width="25px" height="25px" viewBox="0 0 52 52" enable-background="new 0 0 52 52" xml:space="preserve">
	...
	c0-5,4.9-10,9.9-10V6C15,6,8.1,13,8.1,22z" fill="#fff"/>
                                 <path d="M41.8,20.3c-0.4-0.3-1-0.3-1.4,0l-8,8.3c-0.6,0.6-0.1,1.4,0.9,1.4h4.8c0,6-4.1,10-10.1,10v6
	c9,0,16.1-7,16.1-16H49c1,0,1.5-0.9,0.9-1.4L41.8,20.3z" fill="#fff"/>
                                 <path d="M50,3.5C50,2.7,49.3,2,48.5,2h-15C32.7,2,32,2.7,32,3.5v11c0,0.8,0.7,1.5,1.5,1.5h15c0.8,0,1.5-0.7,1.5-1.5
	V3.5z"fill="#fff" />
                              </svg><span class="Polaris-Text--root Polaris-Text--bodySm Polaris-Text--medium">Swipe Products</span></button>
                           <span class="Polaris-Text--root Polaris-Text--bodySm Polaris-Text--medium sd-replace-btn-error" style="color:red; display:none;"> </span>
                        </div>
               ...
               <div class="">
                  ...
                  <div class="Polaris-DataTable sd_common_datatable">
                     <div class="Polaris-DataTable__ScrollContainer">
                        ...
                        <div class="top-bar-datatable">
                           <link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/2.0.7/css/dataTables.dataTables.css">
                           <link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/searchbuilder/1.7.1/css/searchBuilder.dataTables.css">
                           <link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/datetime/1.5.2/css/dataTables.dateTime.min.css">
                           <select id="sd-gender" name="gender" class="sd_custom-data-table" style="padding: 5px; border: 1px solid #ccc; border-radius: 5px; width:90px;">
                              <option value="">Gender</option>
                              <option value="MEN">MEN</option>
                              <option value="WOMEN">WOMEN</option>
                           </select>

                           <select id="sd-product_type-men" name="productType" class="sd_custom-data-table" style="display: none; padding: 5px; border: 1px solid #ccc; border-radius: 5px; width:118px;">
                              <option value="">Product Type</option>
                              <option value="MID">MID</option>
                              <option value="LONG">LONG</option>
                           </select>

                           <select id="sd-product_type-women" name="productType" class="sd_custom-data-table" style="display: none; padding: 5px; border: 1px solid #ccc; border-radius: 5px; width:138px;">
                              <option value="">Product Type</option>
                              <option value="CROP">CROP</option>
                              <option value="HIGH-WAISTED">HIGH WAISTED</option>
                           </select>

                           <select id="sd-size-men" name="size" class="sd_custom-data-table" style="display: none; padding: 5px; border: 1px solid #ccc; border-radius: 5px; width:65px;">
                           ...
                           <select id="sd-size-women" name="size" class="sd_custom-data-table" style="display: none; padding: 5px; border: 1px solid #ccc; border-radius: 5px; width:65px;">
                              <option value="">Size</option>
                           ...
                           <button class="Polaris-Button Polaris-Button--pressable Polaris-Button--variantPrimary Polaris-Button--sizeMedium Polaris-Button--textAlignCenter reset-custom-filter" type="button" style="background: #400790; color:white;">
                        ...
                        <table class="Polaris-DataTable__Table" id="Subscription-Table-Custom">
                           <thead>
                              <tr>
                                 <th data-polaris-header-cell="true" class="Polaris-DataTable__Cell Polaris-DataTable__Cell--verticalAlignTop Polaris-DataTable__Cell--firstColumn Polaris-DataTable__Cell--header" scope="col" aria-sort="none">
                                    <label class="Polaris-Choice Polaris-Checkbox__ChoiceLabel" for="sd_subscription-select-all">
                                       <span class="Polaris-Choice__Control">
                                          <span class="Polaris-Checkbox">
                                             <input id="sd_subscription-select-all" type="checkbox" class="Polaris-Checkbox__Input sd_subscription-all-checkbox" aria-invalid="false" role="checkbox" aria-checked="false" value="">
                                 ...
                                 <th data-polaris-header-cell="true" class="Polaris-DataTable__Cell Polaris-DataTable__Cell--verticalAlignTop Polaris-DataTable__Cell--firstColumn Polaris-DataTable__Cell--header" scope="col" aria-sort="none" style="display:none;">Gender</th>
                                 <th data-polaris-header-cell="true" class="Polaris-DataTable__Cell Polaris-DataTable__Cell--verticalAlignTop Polaris-DataTable__Cell--firstColumn Polaris-DataTable__Cell--header" scope="col" aria-sort="none" style="display:none;">Product type</th>
                                 <th data-polaris-header-cell="true" class="Polaris-DataTable__Cell Polaris-DataTable__Cell--verticalAlignTop Polaris-DataTable__Cell--firstColumn Polaris-DataTable__Cell--header" scope="col" aria-sort="none" style="display:none;">Size</th>
                                 ...
                                 <th data-polaris-header-cell="true" class="Polaris-DataTable__Cell Polaris-DataTable__Cell--verticalAlignTop Polaris-DataTable__Cell--header Polaris-DataTable__Cell--numeric" scope="col" aria-sort="none">Product SKU</th>
                           ...
                           <tbody>
                              <?php
                              if (!empty($getContractData)) {
                                 // echo '<p class="inder-testing" style"display:none;"><pre>' . print_r($getContractData, true) . '</pre></p>';

                                 foreach ($getContractData as $value) {
                                    if ($logged_in_customer_id == '') {
                                       $orderLink = 'https://' . $mainobj->store . '/admin/orders/' . $value['order_id'];
                                    } else {
                                       $orderLink = 'https://' . $mainobj->store . '/account/orders/' . $value['order_token'];
                                    }
                                    $unread_contract = '';
                                    $add_new_class = '';
                                    $customer_name = $value['name'];
                                    $productSku = $value['variant_sku'] ?? 'empty';
                                    ...
                                    echo '<td class="Polaris-DataTable__Cell Polaris-DataTable__Cell--verticalAlignTop Polaris-DataTable__Cell--numeric sd_subscription-checkbox-td"><label class="Polaris-Choice Polaris-Checkbox__ChoiceLabel" for="sd_subscription-' . $value['contract_id'] . '">
                                    <span class="Polaris-Choice__Control">
                                        <span class="Polaris-Checkbox">
                                        <input id="sd_subscription-' . $value['contract_id'] . '" type="checkbox" class="Polaris-Checkbox__Input sd_subscription-checkbox" data-query-string="' . $value['contract_id'] . '" aria-invalid="false" role="checkbox" aria-checked="false" value="">
                                        <span class="Polaris-Checkbox__Backdrop">
                                        </span>
                                        <span class="Polaris-Checkbox__Icon Polaris-Checkbox--animated">
                                            <svg viewBox="0 0 16 16" shape-rendering="geometricPrecision" text-rendering="geometricPrecision">
                                    ...
                                    echo '<td class="Polaris-DataTable__Cell Polaris-DataTable__Cell--verticalAlignTop Polaris-DataTable__Cell--numeric" style="display:none;">' .$value['sd_gender'] ?? ''. '</td>';

                                    echo '<td class="Polaris-DataTable__Cell Polaris-DataTable__Cell--verticalAlignTop Polaris-DataTable__Cell--numeric" style="display:none;">' .$value['sd_product_type'] ?? ''. '</td>';

                                    echo '<td class="Polaris-DataTable__Cell Polaris-DataTable__Cell--verticalAlignTop Polaris-DataTable__Cell--numeric" style="display:none;">' .$value['sd_size'] ?? ''. '</td>';
                                

                                    echo '<td class="Polaris-DataTable__Cell Polaris-DataTable__Cell--verticalAlignTop Polaris-DataTable__Cell--numeric"><div class="sd_customerData"><span class="user-name">' . implode('', array_map(function ($customer_name) {
                                       if ($customer_name) {
                                          return strtoupper($customer_name[0]);
                                       }
                                    }, explode(' ', $customer_name))) . '</span><div class="sd_customerDetails"><strong>' . $value['name'] . '</strong><br><span>' . $value['email'] . '</div></span></div></td>';
                          ...
                          <div id="PolarisTooltipContent2" role="tooltip" class="Polaris-Tooltip-TooltipOverlay__Content">View</div></div></div></td>';
                                    ...
                                    echo '<td class="Polaris-DataTable__Cell Polaris-DataTable__Cell--verticalAlignTop Polaris-DataTable__Cell--numeric">' . $productSku . '</td>';
                                    echo '<td class="Polaris-DataTable__Cell Polaris-DataTable__Cell--verticalAlignTop Polaris-DataTable__Cell--numeric">' . $mainobj->getShopTimezoneDate($value['created_at'], $shop_timezone) . '</td>';
                                    echo '<td class="Polaris-DataTable__Cell Polaris-DataTable__Cell--verticalAlignTop Polaris-DataTable__Cell--numeric">' . $mainobj->getShopTimezoneDate(($value['next_billing_date'] . ' ' . $date_time_array[1]), $shop_timezone) . '</td>';
...
<script>
     ...
     $(document).ready(function() {
      ...
      var table = $('#Subscription-Table-Custom').DataTable({
         select: true
      });

      $('.sd_custom-data-table').on('change', function() {
         let gender = $('#sd-gender').val();

         if (gender === 'MEN') {
               $('#sd-product_type-men').show();
               $('#sd-size-men').show();
               $('#sd-product_type-women').hide();
               $('#sd-size-women').hide();
         } else if (gender === 'WOMEN') {
               $('#sd-product_type-women').show();
               $('#sd-size-women').show();
               $('#sd-product_type-men').hide();
               $('#sd-size-men').hide();
         } else {
               $('#sd-product_type-men').hide();
               $('#sd-size-men').hide();
      ...
      $.fn.dataTable.ext.search.push(
         function(settings, data, dataIndex) {
               let sd_gender = $('#sd-gender').val();
               let sd_product = '';
               let sd_size = '';

               if (sd_gender === 'MEN') {
                  sd_product = $('#sd-product_type-men').val();
                  sd_size = $('#sd-size-men').val();
               } else if (sd_gender === 'WOMEN') {
                  sd_product = $('#sd-product_type-women').val();
                  sd_size = $('#sd-size-women').val();
               }

               let rowData = table.row(dataIndex).data();
               let genderMatch = sd_gender === '' || sd_gender === rowData[1];
               // var genderMatch = sd_gender === '' || rowData.some(function(item) {
               //    return item.toLowerCase() === sd_gender.toLowerCase();
               // });
               

               let productMatch = sd_product === '' || sd_product === rowData[2];
               let sizeMatch = sd_size === '' || sd_size === rowData[3];

               // return genderMatch;
               return genderMatch && productMatch && sizeMatch;
         }
      );

      jQuery('body').on('click', '.reset-custom-filter', function() {
         $('.sd_custom-data-table').val('');
         $('#sd-product_type-men').hide();
         $('#sd-size-men').hide();
         $('#sd-product_type-women').hide();
         $('#sd-size-women').hide();
...
$('.sd_subscription-checkbox').change(function() {
   if ($('.sd_subscription-checkbox-td input[type="checkbox"]:checked').length > 0 && $('.sd_subscription-checkbox-td input[type="checkbox"]:checked').length < 11) {
...
//    jQuery('body').on('change', '.sd_custom-data-table', function() {
//     let gender = $('#sd-gender').val();
