...
<link href="<?php echo $mainobj->SHOPIFY_DOMAIN_URL ;?>/application/assets/css/docstyle.css" rel="stylesheet">

<script src="<?php echo $mainobj->SHOPIFY_DOMAIN_URL ;?>/application/assets/js/bootstrap.bundle.min.js"></script>
          ...
          <div class="idocs-content">
            <div class="container">
              ...
              <section id="idocs_dashboard">
                ...
                <figure>
                    <img src="<?php echo $mainobj->image_folder; ?>sd_dashboard.png" alt="img" class="img-fluid" />
                </figure>
              </section>
              ...
              <section id="idocs_installation">
                ...
                <p>
                  ...
                  <figure>
                    <img src="<?php echo $mainobj->image_folder; ?>create_subs.png" alt="img" class="img-fluid" />
                  </figure>
                </p>
                <ol>
                  <li>
                    ...
                    <ul>
                      <li>
                        ...
                        <figure>
                          <img src="<?php echo $mainobj->image_folder; ?>pay_per_delivery.png" alt="img" class="img-fluid" />
                        </figure>
                      </li>
                      <li>
                        ...
                        <figure>
                          <img src="<?php echo $mainobj->image_folder; ?>prepaid_plan.png" alt="img" class="img-fluid" />
                        </figure>
                      </li>
                    </ul>
                  </li>
                ...
                <p>
                  ...
                  <figure>
                    <img src="<?php echo $mainobj->image_folder; ?>selling_plan_list.png" alt="img" class="img-fluid" />
                  </figure>
                </p>
                <p>
                ...
                <p>
                  ...
                  <figure>
                    <img src="<?php echo $mainobj->image_folder; ?>edit_button_click.png" alt="img" class="img-fluid" />
                  </figure>
                </p>
                <p>
                  <strong>Selling Plan: </strong> You can add, update, delete selling plans in a Plan from here.
                  <figure>
                    <img src="<?php echo $mainobj->image_folder; ?>edit_group_screen.png" alt="img" class="img-fluid" />
                  </figure>
                </p>
                <p>
                  <strong>Products: </strong> You can manage products in a Plan from here.
                  <figure>
                    <img src="<?php echo $mainobj->image_folder; ?>edit_product_tab.png" alt="img" class="img-fluid" />
                  </figure>
                </p>
              ...
              <section id="idocs_html_structure">
                ...
                <img src="<?php echo $mainobj->image_folder; ?>contract_list.png" alt="img" class="img-fluid" />
              ...
              <section id="idocs_sass">
                ...
                <img src="<?php echo $mainobj->image_folder; ?>update_contract.png" alt="img" class="img-fluid" />
              ...
              <section id="idocs_color_schemes">
                ...
                <p>
                  ...
                  <figure>
                    <img src="<?php echo $mainobj->image_folder; ?>product_page_setting.png" alt="img" class="img-fluid w-100">
                  </figure>
                </p>
                ...
                <p>
                  ...
                  <figure>
                    <img src="<?php echo $mainobj->image_folder; ?>customer_account_page.png" alt="img" class="img-fluid w-100">
                  </figure>
                </p>
                ...
                <p>
                  ...
                  <ol>
                    ...
                    <figure>
                    <img src="<?php echo $mainobj->image_folder; ?>email_configuration.png" alt="img" class="img-fluid w-100">
                  </figure>
                </p>
                ...
                <p>
                  ...
                  <ol>
                    ...
                    <figure>
                    <img src="<?php echo $mainobj->image_folder; ?>email_setting.png" alt="img" class="img-fluid w-100">
                  </figure>
                </p>
                <p>
                  ...
                  <figure>
                    <img src="<?php echo $mainobj->image_folder; ?>email_notification.png" alt="img" class="img-fluid w-100">
                  </figure>
                </p>
              </section>
              <hr class="divider" />
              <section id="idocs_analytics">
                <p>
                  ...
                  <figure>
                    <img src="<?php echo $mainobj->image_folder; ?>sd_analytics.png" alt="img" class="img-fluid w-100">
                  </figure>
                </p>
              </section>
              <hr class="divider" />
              <section id="idocs_theme_integrate">
                <p>
                  ...
                  <figure>
                    <img src="<?php echo $mainobj->image_folder; ?>theme_integrate.png" alt="img" class="img-fluid w-100">
                  </figure>
                </p>
               </section>
              <section id="idocs_contactUs">
                <p>
                  ...
                  <figure>
                    <img src="<?php echo $mainobj->image_folder; ?>sd_contactUs.png" alt="img" class="img-fluid w-100">
                  </figure>
                </p>
              </section>
              <hr class="divider" />
              ...
              <section id="idocs_faq">
                ...
                <ul>
                  <li>Make Sure you have enabled the app from Theme Customizer. Follow the Steps in the Shopify Admin Panel: -
                    <i>Online Store->Current Theme->Customize->Theme Settings->App embeds-> Advanced Subscription-> Enable the toggle button -> Save</i>
                ...
                <p>If still facing issues, Kindly contact us at <a href="mailto:your-email.com">your-email.com</a> </p>
                <p class="text-4">
