            ...
            <div class="Polaris-Card__Header">
               <div class="Polaris-Stack Polaris-Stack--alignmentCenter">
                  <div class="Polaris-Stack__Item Polaris-Stack__Item--fill">
					 ...
					 <input type="text" value="" name="subscription_heading" class="subscription_plan_name restrict_input_single_quote" maxlength="<?php echo $mainobj->input_max_character; ?>">
                <img subscription-group-id=" " src="<?php echo $mainobj->image_folder; ?>MobileCancelMajor.svg" class="plan_name_actions cancel_plan_name">
					 <img class="plan_name_actions save_plan_name" case-type="edit" src="<?php echo $mainobj->image_folder; ?>MobileAcceptMajor.svg">
					 </div>
               ...
               <div class="Polaris-Stack Polaris-Stack--alignmentCenter">
                  <div>
                     <div class="Polaris-ButtonGroup">
                        <!--<div class="Polaris-ButtonGroup__Item"><button class="save-subscription-plan Polaris-Button Polaris-Button--primary update-btn sd_button" type="button">Update</button></div>-->
