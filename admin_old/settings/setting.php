                                ...
                                <div class="Polaris-Stack__Item">
                                  <div class="Polaris-ButtonGroup">
                                    <div class="Polaris-ButtonGroup__Item Polaris-ButtonGroup__Item--plain">
                                      <a class="Polaris-Button Polaris-Button--plain navigate_element sd_select_setting" data-query-string="" data-redirect-link="/admin/settings/widget_setting.php?shop=<?php echo $mainobj->store; ?>" data-confirmbox="no" tabindex="0" href="javascript:void(0)" data-polaris-unstyled="true">Manage</a>
                                    </div>
                                </div>
                            </div>
                            </div>
                        ...
                        <div class="Polaris-FormLayout__Items">
                          <div class="Polaris-FormLayout__Item sd_customerAccountSetting">
                            <div class="Polaris-Card">
                              ...
                              <div class="Polaris-Stack__Item">
                                <div class="Polaris-ButtonGroup">
                                  <div class="Polaris-ButtonGroup__Item Polaris-ButtonGroup__Item--plain"><a class="Polaris-Button Polaris-Button--plain navigate_element sd_select_setting" data-query-string="" data-redirect-link="/admin/settings/email_templates/email_templates_list.php?shop=<?php echo $mainobj->store; ?>" data-confirmbox="no" tabindex="0" href="javascript:void(0)" data-polaris-unstyled="true">Manage</a></div>
                                </div>
                              </div>
                            </div>
                            </div>
