...
if($logged_in_customer_id == ''){
 ...
 $empty_contract_redirect_page = $mainobj->SHOPIFY_DOMAIN_URL .'/admin/subscription/subscriptions.php?shop='. $mainobj->store;
...
if(isset($_GET['contract_id']) && ($_GET['contract_id'] != '')){
   ...
   // if($contractId == '15409512730'){
   //    echo '<pre>';
   //    print_r($contractMethodToken);
   // }
         ...
         <div class="Polaris-Page-Header Polaris-Page-Header--isSingleRow Polaris-Page-Header--mobileView Polaris-Page-Header--noBreadcrumbs Polaris-Page-Header--mediumTitle">
            <div class="Polaris-Page-Header__Row sd_contractNavigation">
               <div class="Polaris-Page-Header__BreadcrumbWrapper sd_contractHeader">
                  <nav role="navigation">
                     <a class="Polaris-Breadcrumbs__Breadcrumb  navigate_element" data-usecase="subscription_form_leave" data-heading="Unsaved changes" data-query-string="" data-message="If you leave this page, any unsaved changes will be lost." data-acceptbuttontext="" data-rejectbuttontext="" data-confirmbox="" data-redirect-link="/admin/subscription/subscriptions.php?shop=<?php echo $mainobj->store; ?>" data-polaris-unstyled="true" href="javascript:void(0)">
...
<div class="Polaris-Layout__Section sd-dashboard-page  <?php echo  $parent_class; ?>">
 <div>
 <div class="Polaris-Card__Header sd_contractHeader"><div class="Polaris-Stack Polaris-Stack--alignmentBaseline"><div class="Polaris-Stack__Item Polaris-Stack__Item--fill"><h2 class="Polaris-Heading">Subscriptions</h2></div>
 <?php if($logged_in_customer_id == ''){ ?>
<div class="Polaris-Stack__Item"><div class="Polaris-ButtonGroup"><div class="Polaris-ButtonGroup__Item Polaris-ButtonGroup__Item--plain"><button class="Polaris-Button Polaris-Button--primary sd_selectSetting" data-popup="contract_setting" type="button"><svg viewBox="0 0 20 20"><path d="M18.414 1.586a2 2 0 010 2.828l-3 3-1.115 1.115-2.828-2.828 1.232-1.233.015-.015 2.868-2.867a2 2 0 012.828 0zm-8.47 11.299l-2.788-2.787a4.67 4.67 0 01-5.919-5.901L3.76 6.719a1.5 1.5 0 002.121 0l.84-.84a1.5 1.5 0 000-2.12L4.197 1.236a4.67 4.67 0 015.9 5.919l2.787 2.787 5.506 5.506a2.08 2.08 0 01-2.942 2.942l-5.506-5.506zm-1.415 1.414l-3.287 3.287L1 19l1.414-4.243 3.287-3.286 2.828 2.828z" fill="#929eab"></path></svg><span class="Polaris-Button__Content"><span class="Polaris-Button__Text">Subscripiton Setting</span></span></button></div></div></div>
 <?php } ?>
 </div></div>
    <div class="Polaris-Page__Content">
      <div class="">
        <div class="">
          ...
          <div class="Polaris-DataTable sd_common_datatable">
            <div class="Polaris-DataTable__ScrollContainer">
              <table class="Polaris-DataTable__Table" id="subscriptionTable">
                <thead>
                  <tr>
                    ...
                    <?php
                      if(!empty($getContractData)){
                        foreach ($getContractData as $value) {
                          ...
                          $date_time_array = explode(' ', $updated_at_date);
                          if($value['delivery_policy_value'] == $value['billing_policy_value']){ $planType = "Pay Per Delivery"; }else{ $planType = "Prepaid"; }
                          if($value['contract_status'] == 'A'){ $contract_status = "Active"; $contract_statusClass = "statusSuccess"; $addCircle='<span class="Polaris-Badge__Pip"><span class="Polaris-VisuallyHidden"></span></span>';}else if($value['contract_status'] == 'P'){ $contract_status = "Paused"; $contract_statusClass = "statusAttention"; $addCircle = '';}else if($value['contract_status'] == 'C'){ $contract_status = "Cancelled"; $contract_statusClass = "statusInfo"; $addCircle = '';}
                          ...
                          echo '<td class="Polaris-DataTable__Cell Polaris-DataTable__Cell--verticalAlignTop Polaris-DataTable__Cell--numeric"><div class="sd_customerData"><span class="user-name">'. implode('', array_map(function($customer_name) { return strtoupper($customer_name[0]); }, explode(' ', $customer_name))).'</span><div class="sd_customerDetails"><strong>'.$value['name'].'</strong><br><span>'.$value['email'].'</div></span></div></td>';
